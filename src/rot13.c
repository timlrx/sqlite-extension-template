...
static void rot13Version(sqlite3_context *context, int argc, sqlite3_value **argv) {
...
*/
static int rot13CollFunc(void *notUsed, int nKey1, const void *pKey1, int nKey2,
                         const void *pKey2) {
...
#endif
    int sqlite3_rot_init(sqlite3 *db, char **pzErrMsg, const sqlite3_api_routines *pApi) {
  int rc = SQLITE_OK;
